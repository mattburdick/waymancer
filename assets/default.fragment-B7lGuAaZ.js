import{A as e}from"./index-ThQC3wug.js";import"./fogFragment-C5on34UT.js";import"./mainUVVaryingDeclaration-DENGB-R8.js";import"./helperFunctions-IcraxrVJ.js";import"./imageProcessingFunctions-8xYh_Gbh.js";import"./logDepthDeclaration-CG56KgYp.js";import"./logDepthFragment-CyfYWNaW.js";var t=`decalFragmentDeclaration`,n=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=E);var D=`bumpFragmentMainFunctions`,O=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=O);var k=`bumpFragmentFunctions`,A=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=A);var j=`bumpFragment`,M=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=M);var N=`decalFragment`,P=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=P);var F=`depthPrePass`,I=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=I);var L=`lightFragment`,R=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=R);var z=`oitFragment`,B=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=B);var V=`defaultPixelShader`,H=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[V]||(e.ShadersStore[V]=H);const U={name:V,shader:H};export{U as defaultPixelShader};