import{A as e}from"./index-Dz5R4xwe.js";var t=`circleOfConfusionPixelShader`,n=`uniform sampler2D depthSampler;varying vec2 vUV;
...
`;e.ShadersStore[t]||(e.ShadersStore[t]=n);const r={name:t,shader:n};export{r as circleOfConfusionPixelShader};